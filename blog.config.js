const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Charliiai', // 您的昵称 例如 
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'charliiai@xlearn.shop', // 邮箱地址 
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/charliiai?igsh=MXQ4dDNmcTVkOWozOA==', // 您的instagram地址
 ...
 CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || '4K8tCGFd610RmxBty5-Jf',
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || '', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'Charliiai', // 你的代码仓库名， 例如我是 ''； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'Charliiai', // 你的Github仓库名 e.g ''
  ...
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || '', // 管理员用户名、一般是自己 e.g ''
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || '', // 请配置完整的Waline评论地址 例如 
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '', // id，在51la后台获取 参阅 
  ...
  ANALYTICS_ACKEE_TRACKER:
    process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_TRACKER || '', // e.g ''
